...
# Classes
Numbers are hotbar positions.
### Engineer
1. HE sniper
	- 5/20
2. shotgun
	- 2/16
3. skill: instant build
	- CD: 60
4. (de)construction beam
...
- perk: can hold 1 building

### Grenadier
1. mortar (useful as movement tech)
	- 12/120
2. artilery laser
	- 1/6
3. skill: shield
	- CD: 40, Radius: 10, Duration: 10
4. (de)construction beam
...
- really weak if enemies get close, needs help from turrets or teammates if surrounded
